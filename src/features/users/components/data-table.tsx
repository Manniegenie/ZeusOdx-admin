    ...
    <div className="w-full h-full">
      <div className="w-full flex items-center justify-between py-4">
        ...
        <div className="flex items-center justify-end gap-2">
          <Link to={`/user-management/create-new-admin`} className="bg-primary text-white border border-black/70 w-fit px-3 py-1 rounded text-xs flex items-center gap-2"><User2Icon className="h-3 w-4" /> Add user</Link>
